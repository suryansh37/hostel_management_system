...
#chilanka
Label(sroot,text="Hostel Management System ",font='Timesnewroman 40 ',bg='skyblue',fg='black').place(x=250,y=10)
...
def mainroot():
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='MINI PROJECT',fg='blue',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Ashok Wade",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Phone number : 567821201",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : ashokwade.69@hotmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Mr Chawrey Mama",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Phone no :72611762",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : chawremama69@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="MESS",bg='white',font='msserif 17 bold').place(x=72,y=0)#pack(side='top')
		Label(emp1inf,text="Mr. Santosh Gupta",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Phone number: 9931046699",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : santosh@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Phone number : 9579802224",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail : Mr Govind",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)
		emp1inf.pack_propagate(False)
	...
	def reserve():
		...
		noc.insert(0, 'Enter Enrollment number *')
		noa.insert(0, 'Enter College name *')
		nod.insert(0, 'Number of Semester of Stay *')
		
		def on_entry_click7(event):
			if noc.get() == 'Enter Enrollment number *' :
				noc.delete(0,END)
				noc.insert(0,'')
		def on_entry_click8(event):
			if noa.get() == 'Enter College name *' :
				noa.delete(0,END)
				noa.insert(0,'')
		def on_entry_click9(event):
			if nod.get() == 'Number of Semester of Stay *' :
				nod.delete(0,END)
				nod.insert(0,'')
		def on_exit7(event):
			if noc.get()=='':
		...
		pmethod = IntVar()
		def booking():
			if fn.get() == 'First Name' or ln.get() == 'Last Name' or cn.get() == 'Contact Number *' or em.get() == 'Email' or ad.get() == "Applicant Address" or noc.get() == 'Enter Enrollment number ' or noa.get() == 'Enter College name' or nod.get() == 'Number of Semester of Stay' or roomn.get() == 'Enter Room Number':
				...
				if temp[0] == 'Reserved':
					...
					def f():
						if pmethod != '':
							...
							messagebox.showinfo("Successful","Hostel Room Booked successfully")
							con.commit()
